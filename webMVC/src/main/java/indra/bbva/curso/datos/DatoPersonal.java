...
public class DatoPersonal implements Serializable {
	...
	@ManyToMany(mappedBy="datosPersonales1")
	private List<Publicacion> publicaciones1;
	...
	private List<Publicacion> publicaciones2;
	...
	public List<Publicacion> getPublicaciones1() {
		return this.publicaciones1;
	}

	public void setPublicaciones1(List<Publicacion> publicaciones1) {
		this.publicaciones1 = publicaciones1;
	}

	public List<Publicacion> getPublicaciones2() {
		return this.publicaciones2;
	}

	public void setPublicaciones2(List<Publicacion> publicaciones2) {
